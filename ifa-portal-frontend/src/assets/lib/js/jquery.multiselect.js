  ...
  $.widget("ech.multiselect", {
      ...
      var button = (this.button = $(
        ...
        headerLinkContainer = (this.headerLinkContainer = $("<ul />"))
          ...
          .html(function() {
            if (o.header === true) {
              return (
                '<li><div class="ui-multiselect-wrapper ui-multiselect-wrapper__selct-all"><a class="ui-multiselect-all" href="#"><span class="ui-icon ui-icon-check"></span><span>' +
                o.checkAllText +
                '</span></a></div></li><li><div class="ui-multiselect-wrapper ui-multiselect-wrapper__selct-none"><a class="ui-multiselect-none" href="#"><span class="ui-icon ui-icon-closethick"></span><span>' +
                o.uncheckAllText +
                "</span></a></div></li>"
              );
          ...
          .append(
            '<li class="ui-multiselect-close"><a href="#" class="ui-multiselect-close"><span class="ui-icon ' +
              o.closeIcon +
              '"></span></a></li>'
          )
          .appendTo(header),
    ...
    refresh: function(init) {
      ...
      function makeItem(option, isInOptionGroup) {
        ...
        var inputID =
          ...
          multiselectID +
          "-" +
          (option.id || id + "-option-" + inputIdCounter++);
      ...
      el.children().each(function(i) {
        ...
        if (this.tagName === "OPTGROUP") {
          var $groupLabel = $("<li/>")
            .addClass("ui-multiselect-optgroup-label " + this.className)
            .appendTo($dropdown);
          var $link = $("<a/>")
            .attr("href", "#")
      ...
      if (numChecked === 0) {
        ...
        if ($.isFunction(o.selectedText)) {
          ...
          value = $checked
            ...
            .get()
            .join(o.selectedListSeparator);
        } else {
          if (numChecked === 1) {
            $inputs.each(function(index) {
              if ($inputs[index].checked) {
                value = o.onlySelectedText
                  .replace("#", $('label[for="' + $inputs[index].id + '"]').text());
              }
            });
          } else {
            value = o.selectedText
              .replace("#", numChecked)
              .replace("#", $inputs.length);
          }
        }
      }
      ...
      this.menu
        .delegate(
          ...
          function(e) {
            ...
            var $inputs = $this
              .parent()
              .nextUntil(":not(.ui-multiselect-optgrp-child)")
    ...
    _setOption: function(key, value) {
      ...
      switch (key) {
        ...
        case "checkAllText":
          menu
            .find("a.ui-multiselect-all span")
            .eq(-1)
            .text(value);
          break;
        case "uncheckAllText":
          menu
            .find("a.ui-multiselect-none span")
            .eq(-1)
            .text(value);
          break;
        case "height":
