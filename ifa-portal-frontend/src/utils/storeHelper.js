...
import {
  displayPatternConfigs as displayPatternModel,
  selectPatternConfigs as selectPatternModel
} from '@/utils/codeListLoader'
...
export const storeLoginResponse = function(response) {
  ...
  store.commit('code/setCodeValue', displayPatternModel)
  // 全ての CodeList をロードして追加
  store.commit('code/setCodeList', selectPatternModel)
}
