  ...
  <table :class="{ _table__body: true, narrow_padding_print: isPrint }">
    ...
    >
      <tr>
        ...
        ></th>
        <td class="_table__data _right">{{ $_out($_withCommaNoneZeroPadding(item.valuation)) }}</td>
    ...
    <tbody>
      <tr>
        ...
        <td class="_table__data _right">{{ $_out($_withCommaNoneZeroPadding(assetsTableData.portfolioSummaryValuationTotal)) }}</td>
        <td class="_table__data _right">
