...
export class IfaFxOrderInputA008RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    ...
    this.exchangeOrderAmount = obj.exchangeOrderAmount ? obj.exchangeOrderAmount : '' // 注文金額
    ...
    this.foreignApproximateDeliveryAmount = obj.foreignApproximateDeliveryAmount ? obj.foreignApproximateDeliveryAmount : '' // 概算外貨数量
