  ...
  >
    ...
    <el-row style="margin-top: 20px;">
      ...
      >
        <ifa-button
          text="出金明細一覧へ"
          action-id="SUB0202_0601-03_2#A002"
...
import { IfaWithdrawCancelCompleteFormModel } from './js/IfaWithdrawCancelCompleteFormModel'
...
export default {
  ...
  data() {
    return {
      form: new IfaWithdrawCancelCompleteFormModel(),
  ...
  methods: {
    ...
    setMsg() {
      ...
      this.messages.mains.push('下記の内容で出金取消を受け付けました。')
      this.messageKey++
    },
    onDialogClose() {
