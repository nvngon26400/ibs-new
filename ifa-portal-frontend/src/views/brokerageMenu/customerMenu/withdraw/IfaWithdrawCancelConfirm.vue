<template>
  ...
  <el-dialog
    ...
    :center="true"
    :show-close="false"
    :before-close="onDialogCancelClose"
  ...
  >
    ...
    <el-row>
      ...
      >
        <ifa-button
          ...
          @app-action-handler="onDialogCancelClose"
        ></ifa-button>
      </el-col>
    </el-row>
    ...
    <el-row style="margin-top: 20px;">
      ...
      >
        <ifa-button
          id="btnWithdrawCancel"
          text="取消実行"
          style="padding-left: 0;"
          action-id="SUB0202_0601-03_1#A001"
...
import { IfaWithdrawCancelConfirmFormModel } from './js/IfaWithdrawCancelConfirmFormModel'
import IfaMessageArea from '@/components/Message/IfaMessageArea'
import { IfaWithdrawCancelConfirmA001RequestModel } from './js/IfaWithdrawCancelConfirmA001RequestModel'
export default {
  components: {
    IfaNoticeInfo,
    IfaMessageArea
  ...
  data() {
    return {
      form: new IfaWithdrawCancelConfirmFormModel(),
      confirmData: {},
      messages: {
        mains: [],
        errors: [],
  ...
  computed: {
    ...
    A001RequestModel() {
      return new IfaWithdrawCancelConfirmA001RequestModel(this.form)
    }
  },
  methods: {
    onShow() {
    ...
    handlerExecuteA001(response) {
      ...
      this.$emit('cancel-finish', this.confirmData)
    }
  }
}
</script>
