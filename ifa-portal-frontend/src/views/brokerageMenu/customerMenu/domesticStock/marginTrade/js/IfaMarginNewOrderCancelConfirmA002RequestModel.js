...
export class IfaMarginNewOrderCancelConfirmA002RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    /** EC受注番号（半角英数字）. */
    ...
    /** 自動注文種別（半角英数字）. */
    this.autoOrderClass = obj.autoOrderClass ? obj.autoOrderClass : ''
    /** RBE注文種別（全角半角）. */
    ...
    /** DONE指成区分（半角英数字）. */
    this.doneSasinariKbn = obj.doneSasinariKbn ? obj.doneSasinariKbn : ''
    /** DONE指値（数値(小数)）. */
    this.doneSashine = obj.doneSashine ? obj.doneSashine : ''
    /** DONERBE注文種別（全角半角）. */
    this.doneRbeOrderKind = obj.doneRbeOrderKind ? obj.doneRbeOrderKind : ''
    /** DONEトリガ発動ゾーン（半角英数字）. */
    this.doneTriggerZone = obj.doneTriggerZone ? obj.doneTriggerZone : ''
    /** DONEトリガ値段（数値(小数)）. */
    this.doneTriggerNedan = obj.doneTriggerNedan ? obj.doneTriggerNedan : ''
    /** DONEOCO指成区分（半角英数字）. */
    this.doneOcoSasinariKbn = obj.doneOcoSasinariKbn ? obj.doneOcoSasinariKbn : ''
    /** DONEOCO指値（数値(小数)）. */
    this.doneOcoSashine = obj.doneOcoSashine ? obj.doneOcoSashine : ''
    /** DONE有効期限（全角半角）. */
    this.doneYuukouKigen = obj.doneYuukouKigen ? obj.doneYuukouKigen : ''
    /** RBE注文ステータス（半角英数字）. */
