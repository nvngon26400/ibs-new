        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span v-if="form.orderKind === '1' && form.sasinariHouhou === '3'">逆指値注文</span>
            ...
            <!-- 注文内容 OCO1 (注文種別が OCO の時のみ表示)-->
            <el-row v-if="form.orderKind === '2'">
              <el-row
                v-if="!(toBoolean(form.workingStatus))"
                class="dotted_border"
              >
                <el-col :span="8">
      ...
      <el-row style="margin-top: 20px;">
        ...
        >
          <ifa-button
            ...
            action-id="SUB0202_0212-07_1#A002"
            :request-model="IfaMarginRepayOrderCancelConfirmA002RequestModel"
            @response-handler="orderPlacementA002"
          ></ifa-button>
        </el-col>
      </el-row>
...
<script>
import { IfaMarginRepayOrderCancelConfirmFormModel } from './js/IfaMarginRepayOrderCancelConfirmFormModel.js'
import { IfaMarginRepayOrderCancelConfirmA002RequestModel } from './js/IfaMarginRepayOrderCancelConfirmA002RequestModel.js'
...
export default {
  ...
  data() {
    return {
      form: new IfaMarginRepayOrderCancelConfirmFormModel(),
      priceParam: {
        sasinariHouhou: '',
        sasinariJyouken: '',
        triggerPrice: '',
  ...
  computed: {
    ...
    IfaMarginRepayOrderCancelConfirmA002RequestModel() {
      return new IfaMarginRepayOrderCancelConfirmA002RequestModel(this.form)
    }
  },
