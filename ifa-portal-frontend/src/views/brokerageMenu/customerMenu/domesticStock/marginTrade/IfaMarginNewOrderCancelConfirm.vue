            ...
            >
              ...
              >
                ...
                >
                  ...
                  ></ifa-text>
                  {{ getPrice(priceParam, form.tradeCd) }}</span>
                <span
                ...
                >
                  ...
                  ></ifa-text>
                  {{ getPrice(ifd1PriceParam, form.tradeCd) }}</span>
              </el-col>
            </el-row>
          ...
          >
            ...
            >
              ...
              >
                ...
                ></ifa-text>
                <span style="white-space: pre-wrap;">{{ getPrice(ifd2PriceParam,form.tradeCd === '3' ? '6' : '5') }}</span>
              </el-col>
            </el-row>
            ...
            <el-row v-if="form.orderKind === '4'">
              ...
              <el-row class="dotted_border">
                ...
                <el-col
                  :span="16"
                >
                  <span style="white-space: pre-wrap;">{{ getOco2Price(form.tradeCd === '3' ? '6' : '5', form.oco1SasinariJyouken) }}</span>
                </el-col>
              </el-row>
            </el-row>
