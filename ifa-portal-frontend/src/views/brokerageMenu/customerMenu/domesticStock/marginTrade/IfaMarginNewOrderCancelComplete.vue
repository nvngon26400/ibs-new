            ...
            >
              ...
              >
                ...
                >
                  ...
                  ></ifa-text>
                  {{ getPrice(priceParam, form.request.tradeCd) }}</span>
                <span
                ...
                >
                  ...
                  ></ifa-text>
                  {{ getPrice(ifd1PriceParam, form.request.tradeCd) }}</span>
              </el-col>
            </el-row>
            <!--空のレスポンスが返ってきたときに表示-->
          ...
          >
            ...
            >
              ...
              >
                ...
                ></ifa-text>
                <span style="white-space: pre-wrap;">{{ getPrice(ifd2PriceParam, form.request.tradeCd === '3' ? '6' : '5') }}</span>
              </el-col>
            </el-row>
            <!-- IFDOCOの時価格欄-->
            <el-row v-if="form.request.orderKind === '4'">
              ...
              <el-row class="dotted_border">
                ...
                <el-col
                  :span="16"
                >
                  <span style="white-space: pre-wrap;">{{ getOco2Price(form.request.tradeCd === '3' ? '6' : '5', form.request.oco1SasinariJyouken) }}</span>
                </el-col>
              </el-row>
            </el-row>
            <!--期間、預り区分、手数料区分、受注日時は共通して表示-->
