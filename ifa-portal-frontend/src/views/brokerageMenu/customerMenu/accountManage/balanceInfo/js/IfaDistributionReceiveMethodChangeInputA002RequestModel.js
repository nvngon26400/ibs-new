...
export class IfaDistributionReceiveMethodChangeInputA002RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    ...
    this.afterChangeDistributionReceiveMethodList = obj.afterChangeDistributionReceiveMethodList ? obj.afterChangeDistributionReceiveMethodList : '' // 変更後分配金受取方法
  }
}
