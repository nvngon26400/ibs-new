...
export class IfaMatchedTradeDetailA001RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    ...
    this.notSpecificDepositTradeType = obj.notSpecificDepositTradeType ? obj.notSpecificDepositTradeType : '' // 非特定預り売買区分
  }
}
