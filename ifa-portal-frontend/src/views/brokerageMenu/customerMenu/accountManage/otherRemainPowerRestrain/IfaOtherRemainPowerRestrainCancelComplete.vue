<template>
  <!-- SUB0202_0110-02_2その他余力拘束注文取消完了 -->
  <el-dialog
    v-model="vmIsVisible"
  ...
  <ifa-requester
    id="ifaOtherRemainPowerRestrainCancelCompleteA001"
    action-id="SUB0202_0110-02_2#A001"
...
import { IfaOtherRemainPowerRestrainCancelCompleteFormModel } from './js/IfaOtherRemainPowerRestrainCancelCompleteFormModel'
...
export default {
  ...
  data() {
    return {
      ...
      // 画面のフォームモデルを初期化
      form: new IfaOtherRemainPowerRestrainCancelCompleteFormModel()
    }
  },
  ...
  methods: {
     ...
     */
    onShow() {
      this.form = new IfaOtherRemainPowerRestrainCancelCompleteFormModel()
      this.$nextTick(() => {
        document.getElementById('ifaOtherRemainPowerRestrainCancelCompleteA001').click()
      })
    },
    /**
