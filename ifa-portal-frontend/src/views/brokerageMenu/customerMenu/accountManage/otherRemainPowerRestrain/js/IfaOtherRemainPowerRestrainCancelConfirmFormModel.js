// SUB0202_0110-02_1 その他余力拘束注文取消確認のフォームモデル
export class IfaOtherRemainPowerRestrainCancelConfirmFormModel {
  constructor() {
    this.screenId = 'SUB0202_0110-02_1'
    this.screenTitle = 'その他余力拘束注文取消確認'
