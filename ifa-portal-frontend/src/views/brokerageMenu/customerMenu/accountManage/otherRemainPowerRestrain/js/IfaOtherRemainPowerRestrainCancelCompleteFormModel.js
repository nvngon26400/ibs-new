// SUB0202_0110-02_2 その他余力拘束注文取消完了のフォームモデル
export class IfaOtherRemainPowerRestrainCancelCompleteFormModel {
  constructor() {
    this.screenId = 'SUB0202_0110-02_2'
    this.screenTitle = 'その他余力拘束注文取消完了'
