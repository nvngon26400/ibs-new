    ...
    <el-row style="margin-top: 20px;">
      ...
      >
        <ifa-button
          ...
          action-id="SUB0202_0704-02_1#A002"
        ...
        <ifa-button
          ...
          text="請求実行"
          style="padding-left: 0;"
          action-id="SUB0202_0704-02_1#A005"
          action-type="requestAction"
...
import { IfaDocRequestExecuteConfirmA002RequestModel } from './js/IfaDocRequestExecuteConfirmA002RequestModel'
import { IfaDocRequestExecuteConfirmA005RequestModel } from './js/IfaDocRequestExecuteConfirmA005RequestModel'
export default {
  components: {
    IfaNoticeInfo,
    IfaMessageArea
  ...
  emits: ['close-modal', 'confirm-finish', 'update:isVisible'],
  setup(props) {
  ...
  computed: {
    ...
    A002RequestModel() {
      return new IfaDocRequestExecuteConfirmA002RequestModel(this.form)
    },
    A005RequestModel() {
      return new IfaDocRequestExecuteConfirmA005RequestModel(this.form)
    }
  },
  methods: {
    onShow() {
      Object.assign(this.form, this.formData)
      this.form.title = '書類請求確認'
      this.setMsg()
    },
    onDialogClose() {
    ...
    setMsg() {
      ...
      this.messages.warns = []
      this.messages.mains.push('書類請求はまだ完了していません。')
      this.messages.mains.push('画面下の請求実行ボタンを押下してください。')
      this.messageKey++
    },
