export class IfaForeignStockCounterOrderCompleteFormModel {
  constructor() {
    this.title = {
      id: 'SUB0202_0302-02-03',
      name: '外国株式店頭注文完了'
    }
    ...
    this.msg = '' // コンプラチェック.メッセージ
    this.complianceRankCheckConfirm = '' // アラート内容確認.コンプラランクチェック確認
    this.noticeInfoAlertConfirm = '' // アラート内容確認.注意情報アラート確認
    this.noticeAlertConfirm = '' // アラート内容確認.お知らせアラート確認
    this.tradeAmountAlertConfirm = '' // アラート内容確認.約定金額アラート確認
    this.overseasEtfAlertConfirm = '' // アラート内容確認.海外ETFアラート確認
    this.chkBoxLabel = '' // コンプラランクチェック確認見出し
    this.noticeInfoAlert = '' // 注意情報アラートメッセージ
    this.noticeAlert = '' // お知らせアラートメッセージ
    this.tradeAmountAlert = '' // 約定金額アラートメッセージ
    this.overseasEtfAlert = '' // 海外ETFアラートメッセージ
  }
}
