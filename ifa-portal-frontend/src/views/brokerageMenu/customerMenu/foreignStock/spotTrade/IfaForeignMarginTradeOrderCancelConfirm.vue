    ...
    <el-row style="margin-top: 20px;">
      ...
      >
        <ifa-button
          ...
          action-id="SUB0202_0303-03_1#A010"
          action-type="requestAction"
          :disabled="authorityHandle()"
          :request-model="IfaForeignMarginTradeOrderCancelConfirmA010RequestModel"
          @response-handler="orderCancellationA010"
          @response-error-handler="orderCancellationA010ErrorHandle"
        ></ifa-button>
      </el-col>
    </el-row>
  </el-dialog>
...
import { IfaForeignMarginTradeOrderCancelConfirmFormModel } from './js/IfaForeignMarginTradeOrderCancelConfirmFormModel'
import { IfaForeignMarginTradeOrderCancelConfirmA010RequestModel } from './js/IfaForeignMarginTradeOrderCancelConfirmA010RequestModel'
...
export default {
  ...
  data() {
    return {
      formModel: new IfaForeignMarginTradeOrderCancelConfirmFormModel(),
      infoView: false
    }
  },
  computed: {
    IfaForeignMarginTradeOrderCancelConfirmA010RequestModel() {
      return new IfaForeignMarginTradeOrderCancelConfirmA010RequestModel(this.formModel)
    },
    bgColor() {
  ...
  methods: {
    ...
    // 取消発注ボタン(エラー)
    orderCancellationA010ErrorHandle(response) {
      notifyWrapper({
