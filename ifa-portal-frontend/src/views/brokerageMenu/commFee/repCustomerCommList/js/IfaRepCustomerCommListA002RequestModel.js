...
export class IfaRepCustomerCommListA002RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    this.brokerCode = obj.brokerCode ? obj.brokerCode.split(',').map(val => val.trim()) : [] // 仲介業者コード
    this.chkBrokerCodeExclude = obj.chkBrokerCodeExclude ? '1' : '0' // 仲介業者除外
    ...
    this.chargeCustomerCountingUnit = obj.chargeCustomerCountingUnit ? obj.chargeCustomerCountingUnit : '' // 集計単位
