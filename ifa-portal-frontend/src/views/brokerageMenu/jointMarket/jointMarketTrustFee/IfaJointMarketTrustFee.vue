<template>
  ...
  <div>
          ...
          <div class="filter-container">
            <el-row>
              ...
              >
                <ifa-common-search
                  ...
                  original-screen-id="SUB0208_02-01"
            ...
            <el-row class="form_button">
              <ifa-button
                ...
                width="90"
                small
                :request-model="IfaJointMarketTrustFeeA002RequestModel"
                :form="formRef"
                action-id="SUB0208_02-01#A002"
      ...
      <el-card class="content-card">
        <el-row class="grid_button_area">
          <ifa-button
            ...
            :form="formRef"
            :request-model="IfaJointMarketTrustFeeA004RequestModel"
            action-id="SUB0208_02-01#A004"
    ...
    <ifa-requester
      id="IfaJointMarketTrustFeeA001"
      action-id="SUB0208_02-01#A001"
      action-type="requestAction"
...
import { IfaJointMarketTrustFeeFormModel } from './js/IfaJointMarketTrustFeeFormModel'
import { IfaJointMarketTrustFeeA002RequestModel } from './js/IfaJointMarketTrustFeeA002RequestModel'
import { IfaJointMarketTrustFeeA004RequestModel } from './js/IfaJointMarketTrustFeeA004RequestModel'
...
export default {
  ...
  data() {
    return {
      ...
      changePtn: 'pt1',
      formRef: {},
      form: new IfaJointMarketTrustFeeFormModel(),
  ...
  computed: {
    IfaJointMarketTrustFeeA002RequestModel() {
      return new IfaJointMarketTrustFeeA002RequestModel(this.form)
    },
    IfaJointMarketTrustFeeA004RequestModel() {
      return new IfaJointMarketTrustFeeA004RequestModel(this.form)
    },
    previousBusinessDay() {
  ...
  methods: {
    onShow(resume) {
      ...
      this.$nextTick(() => {
        ...
        document.getElementById('IfaJointMarketTrustFeeA001').click()
      })
    },
...
obj.colModel = [
  ...
  { title: '共募報酬率', dataIndx: 'jointRate', width: 150, dataType: 'integer', editable: false, halign: 'center', align: 'right', hidden: false,
    render: function(ui) { return ui.rowData.jointRate ? ifaFormatUtils.withCommaNoneZeroPadding(ui.rowData.jointRate) + '%' : '-' } },
  { title: '支払額', dataIndx: 'rewardPrice', width: 150, dataType: 'integer', editable: false, halign: 'center', align: 'right', hidden: false,
...
const viewControllInfoList = [
  { dailyMonthlyCountingUnit: '0', detailCustomerCurrencyCountingUnit: '0', csvFileName: '共同店舗信託報酬_日次_明細', hiddenColumn: ['baseMonth'] },
  { dailyMonthlyCountingUnit: '0', detailCustomerCurrencyCountingUnit: '1', csvFileName: '共同店舗信託報酬_日次_顧客・商品分類・通貨毎', hiddenColumn: ['baseMonth', 'brandCode', 'brandName', 'quantity', 'referencePrice', 'price', 'trustFeeRate', 'jointRate'] },
  { dailyMonthlyCountingUnit: '0', detailCustomerCurrencyCountingUnit: '2', csvFileName: '共同店舗信託報酬_日次_通貨毎', hiddenColumn: ['empCode', 'brokerChargeName', 'buten', 'accountNumber', 'dealerNumber', 'course', 'customerNameKanji', 'customerNameKana', 'baseMonth', 'brandCode', 'brandName', 'quantity', 'referencePrice', 'price', 'trustFeeRate', 'jointRate'] },
  { dailyMonthlyCountingUnit: '1', detailCustomerCurrencyCountingUnit: '0', csvFileName: '共同店舗信託報酬_月次累計_明細', hiddenColumn: ['holdingcDate', 'quantity', 'referencePrice', 'price', 'trustFeeRate', 'jointRate'] },
  { dailyMonthlyCountingUnit: '1', detailCustomerCurrencyCountingUnit: '1', csvFileName: '共同店舗信託報酬_月次累計_顧客・商品分類・通貨毎', hiddenColumn: ['holdingcDate', 'brandCode', 'brandName', 'quantity', 'referencePrice', 'price', 'trustFeeRate', 'jointRate'] },
  { dailyMonthlyCountingUnit: '1', detailCustomerCurrencyCountingUnit: '2', csvFileName: '共同店舗信託報酬_月次累計_通貨毎', hiddenColumn: ['empCode', 'brokerChargeName', 'buten', 'accountNumber', 'dealerNumber', 'course', 'customerNameKanji', 'customerNameKana', 'holdingcDate', 'brandCode', 'brandName', 'quantity', 'referencePrice', 'price', 'trustFeeRate', 'jointRate'] }
]
