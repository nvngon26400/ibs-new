...
export class IfaJointSubscriptSecurityCashBalanceLookupA006RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    ...
    this.aggregatorDetailsCountingUnit = obj.aggregatorDetailsCountingUnit ? obj.aggregatorDetailsCountingUnit : '' // 集計単位(集計/明細)
    this.periodYm = obj.periodYm ? obj.periodYm : '' // 期間指定
