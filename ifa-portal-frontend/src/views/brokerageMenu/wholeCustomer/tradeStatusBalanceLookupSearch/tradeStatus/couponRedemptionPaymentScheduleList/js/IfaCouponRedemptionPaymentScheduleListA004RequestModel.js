...
export class IfaCouponRedemptionPaymentScheduleListA004RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    ...
    this.periodYmFrom = obj.periodYmFrom ? obj.periodYmFrom : '' // 期間指定ＦＲＯＭ
    this.periodYmTo = obj.periodYmTo ? obj.periodYmTo : '' // 期間指定ＴＯ
    this.securiytClass = obj.securiytClass ? obj.securiytClass : '' // 証券種別
