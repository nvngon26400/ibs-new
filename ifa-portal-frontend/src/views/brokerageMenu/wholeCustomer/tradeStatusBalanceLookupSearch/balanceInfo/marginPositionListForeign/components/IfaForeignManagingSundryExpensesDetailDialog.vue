              ...
              <table class="input-table">
                <tr>
                  ...
                  <td class="table-body __right">
                    <el-form-item>
                      <span style="margin-right: 1rem; color: #18181A;">
                        {{ amount.chargeIncludeTax }}&nbsp;USD
                      </span>
                    </el-form-item>
                  </td>
                </tr>
                <tr>
                  <td class="table-label">金利</td>
                  <td class="table-body __right">
                    <el-form-item>
                      <span style="margin-right: 1rem; color: #18181A;">
                        {{ amount.dailyInterest }}&nbsp;USD
                      </span>
                    </el-form-item>
                  </td>
                </tr>
                <tr>
                  <td class="table-label">貸株料</td>
                  <td class="table-body __right">
                    <el-form-item>
                      <span style="margin-right: 1rem; color: #18181A;">
                        {{ amount.stumpLending }}&nbsp;USD
                      </span>
                    </el-form-item>
                  </td>
                </tr>
                <tr>
                  <td class="table-label">管理料(税込)</td>
                  <td class="table-body __right">
                    <el-form-item>
                      <span style="margin-right: 1rem; color: #18181A;">
                        {{ amount.managementFee }}&nbsp;USD
                      </span>
                    </el-form-item>
                  </td>
                </tr>
                <tr>
                  <td class="table-label">名義書換料(税込)</td>
                  <td class="table-body __right">
                    <el-form-item>
                      <span style="margin-right: 1rem; color: #18181A;">
                        {{ amount.rightsProcessingCharge }}&nbsp;USD
                      </span>
                    </el-form-item>
                  </td>
                </tr>
