...
export class IfaMarginPositionListDomesticA005RequestModel {
  constructor(obj) {
    Logger.debug(obj)
    ...
    this.openTradeKbn = obj.newCreditOrderType ? obj.newCreditOrderType : '' // 新規売買区分
    ...
    this.openPrice = obj.unitPriceForeign ? obj.unitPriceForeign : '' // 取得単価
    this.batchIndividualDisplayFlag = '1' // 一括個別表示フラグ
  }
}
