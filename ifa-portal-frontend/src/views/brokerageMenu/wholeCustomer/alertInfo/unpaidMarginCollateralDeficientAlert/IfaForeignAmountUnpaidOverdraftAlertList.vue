<template>
  <!-- 画面名：外貨未入金・赤残アラート一覧 -->
  <div>
    <screen-title text="外貨未入金・赤残アラート一覧"></screen-title>
    <el-form
      ref="form"
      :model="form"
      :inline="true"
            ...
            <div class="filter-container">
              ...
              >
                <ifa-common-search
                  ...
                  display-pattern="pt1"
                  list-pattern="pt2"
                  original-screen-id="SUB020301_01-03"
              ...
              <el-row style="padding-left: 46px; padding-top: 10px; display: block;">
                <ifa-button
                  ...
                  :request-model="ifaForeignAmountUnpaidOverdraftAlertListA002RequestModel"
                  action-id="SUB020301_01-03#A002"
    ...
    <ifa-requester
      id="ifaForeignAmountUnpaidOverdraftAlertListA002"
      action-type="requestAction"
      :request-model="ifaForeignAmountUnpaidOverdraftAlertListA002RequestModelIfaWholePortalHome"
      action-id="SUB020301_01-03#A002"
      @response-handler="responseA002Handler"
      @response-error-handler="responseA002ErrorHandler"
    ></ifa-requester>
...
import { IfaForeignAmountUnpaidOverdraftAlertListA002RequestModel } from './js/IfaForeignAmountUnpaidOverdraftAlertListA002RequestModel'
...
export default {
  ...
  computed: {
    ifaForeignAmountUnpaidOverdraftAlertListA002RequestModel() {
      return new IfaForeignAmountUnpaidOverdraftAlertListA002RequestModel(this.form)
    },
    ifaForeignAmountUnpaidOverdraftAlertListA002RequestModelIfaWholePortalHome() {
      return new IfaForeignAmountUnpaidOverdraftAlertListA002RequestModel(this.serchFormIfaWholePortalHome)
    }
  },
  mounted() {
  ...
  methods: {
    onShow(resume, isRouting) {
      ...
      if (isRouting) {
        ...
        this.$nextTick(() => {
          document.getElementById('ifaForeignAmountUnpaidOverdraftAlertListA002').click()
        })
      }
    },
    preSearch() {
      this.onShow()
      this.ifaForeignAmountUnpaidOverdraftAlertListA002RequestModel.customerNameKanjiKanaTerms = this.form.customerNameKanjiKanaTerms - 1
    },
    handleClear() {
    ...
    handleClick(ui) {
      if (ui.dataIndx === 'detail') {
        this.$_startShowMenu('SUB0202_010303', { butenCode: ui.rowData.buten, accountNumber: ui.rowData.accountNumber })
      }
    },
    ...
    responseA002Handler(data) {
      ...
      this.pqGridOption.dataModel.data = dataList.map(e => {
        return {
          ...
          currency: e.currency,
          remainPower: e.foreignValuation,
          detail: '詳細'
        }
      })
      this.$nextTick(() => {
...
// 外国買付余力アラート
const foreignPurchaseCapacityAlert = [
  ...
  colDefine.foreignNotPaymentInfo, // 外貨未入金・赤残
  colDefine.detail // 詳細
]
...
obj.colModel = foreignPurchaseCapacityAlert
