...
// 社員用メニュー > 取引データ管理
import IfaEdelivConsentDataList from '@/views/companyEmployeeMenu/transactionData/edelivConsentData/IfaEdelivConsentDataList'

export const getTransactionDataMenuConfig = () => {
  return [
    {
      name: 'ifa-edeliv-consent-data-list',
      label: '電子交付同意データ登録',
      menuId: 'SUB0504_02',
      component: shallowRef(IfaEdelivConsentDataList)
    }
  ]
}
