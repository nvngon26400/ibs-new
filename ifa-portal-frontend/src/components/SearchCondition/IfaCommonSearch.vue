<template>
  <div class="ifa-common-search__wrapper">
    ...
    <el-row class="ifa-common-search__align-items">
      ...
      ></ifa-input-text>
      <ifa-input-text
        v-if="selectPattern[0].values.branchCodeIsVisible"
        id="branchCode"
      ...
      patternOptions: [
        ...
        { key: 'pt2',
          values: {
            ...
            branchCodeIsVisible: true,
            empCodeIsVisible: true,
            butenCodeIsVisible: false,
            accountNumberIsVisible: false,
        ...
        { key: 'pt4',
          values: {
            brokerCodeIsVisible: true,
            chkBrokerCodeExcludeIsVisible: false,
            branchCodeIsVisible: false,
            empCodeIsVisible: true,
            butenCodeIsVisible: true,
            accountNumberIsVisible: true,
            customerNameIsVisible: true,
            customerAttributeIsVisible: true,
            brokerCodeMultipleInputsFlag: false
          }
        },
        { key: 'pt5',
          values: {
