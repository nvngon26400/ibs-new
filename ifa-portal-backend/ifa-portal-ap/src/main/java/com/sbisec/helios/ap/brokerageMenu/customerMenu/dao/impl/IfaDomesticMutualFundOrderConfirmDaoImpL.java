...
import com.sbisec.helios.ap.brokerageMenu.customerMenu.dao.mapper.IfaDomesticMutualFundOrderConfirmMapper;
 ...
 */
@Component
public class IfaDomesticMutualFundOrderConfirmDaoImpL extends RowSelectableDao
        implements IfaDomesticMutualFundOrderConfirmDao {
    
    @Autowired
    private IfaDomesticMutualFundOrderConfirmMapper mapper;
    ...
    public int insertIfaDomesticMutualFundOrderConfirmSql001(IfaDomesticMutualFundOrderConfirmSql001RequestModel req)
        ...
        return mapper.insertIfaDomesticMutualFundOrderConfirmSql001(req);
    }
    ...
    public int updateIfaDomesticMutualFundOrderConfirmSql002(IfaDomesticMutualFundOrderConfirmSql002RequestModel req)
        ...
        return mapper.updateIfaDomesticMutualFundOrderConfirmSql002(req);
    }
    ...
    public int updateIfaDomesticMutualFundOrderConfirmSql002b(IfaDomesticMutualFundOrderConfirmSql002RequestModel req)
        ...
        return mapper.updateIfaDomesticMutualFundOrderConfirmSql002b(req);
    }
}
