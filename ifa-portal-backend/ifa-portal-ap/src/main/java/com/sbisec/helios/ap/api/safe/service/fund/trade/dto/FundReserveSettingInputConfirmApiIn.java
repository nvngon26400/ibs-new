...
/**
 * DTOクラス 積立設定入力確認機能IN Dto
 */
public class FundReserveSettingInputConfirmApiIn extends FundTradeDtoIn {

    /**
     * コンストラクタ
     */
    public FundReserveSettingInputConfirmApiIn() {
        super("fund.reserve.setting.input.confirm");
    }
