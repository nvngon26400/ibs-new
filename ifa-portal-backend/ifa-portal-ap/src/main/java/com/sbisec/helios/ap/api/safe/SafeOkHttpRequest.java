 ...
 * @date 3/31/2025
 */
public class SafeOkHttpRequest {
    ...
    private static final String STR_SYSTEM = "helios";
    private static final String STR_CHANNEL = "IFA_PORTAL";

    private ObjectMapper objectMapper;

    public SafeOkHttpRequest() {
    ...
    public void setHeaders(Object obj) throws SafeException {
        try {
            ...
            this.headers.put("channel", STR_CHANNEL);
            this.headers.put("uuid", UUID.randomUUID().toString());
            this.headers.put("sid", IfaCommonUtil.getRequestAttribute(IfaCommonUtil.ATTR_FRAMEWORK_SESSION_ID, String.class));
    ...
    public void setParameters(Object obj) throws SafeException {
        try {
