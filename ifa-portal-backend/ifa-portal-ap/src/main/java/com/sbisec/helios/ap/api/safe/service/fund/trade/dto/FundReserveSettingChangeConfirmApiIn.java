...
/**
 * DTOクラス 積立設定変更確認機能IN Dto
 */
public class FundReserveSettingChangeConfirmApiIn extends FundTradeDtoIn {

    /**
     * コンストラクタ
     */
    public FundReserveSettingChangeConfirmApiIn() {
        super("fund.reserve.setting.change.confirm");
    }
