 ...
 */
@Mapper
public interface IfaReleaseNoteMapper {
     ...
     */
    public String selectIfaReleaseNoteNextDispFlgSql001(@Param("userId") String userId) throws Exception;
     ...
     */
    public List<IfaReleaseNoteSql002ResponseModel> selectIfaReleaseNoteSql002(@Param("displayYear") String displayYear) throws Exception;
     ...
     */
    public int updateIfaReleaseNoteSql003(@Param("userId") String userId) throws Exception;
     ...
     */
    public int updateIfaReleaseNoteNextDispFlgSql004(
            @Param("req") IfaReleaseNoteSql004RequestModel req) throws Exception;
