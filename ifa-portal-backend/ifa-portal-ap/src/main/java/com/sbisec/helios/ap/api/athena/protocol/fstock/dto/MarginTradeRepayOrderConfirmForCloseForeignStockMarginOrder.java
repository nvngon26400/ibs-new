...
/**
 * @Description 信用注文情報（米株信用取引返済注文入力） Dto
 * 
 * @author 髙橋
 * @date 03/04/2024
 */
public class MarginTradeRepayOrderConfirmForCloseForeignStockMarginOrder implements Serializable {

	private static final long serialVersionUID = -5766320439543497081L;

	public MarginTradeRepayOrderConfirmForCloseForeignStockMarginOrder() {
	}
