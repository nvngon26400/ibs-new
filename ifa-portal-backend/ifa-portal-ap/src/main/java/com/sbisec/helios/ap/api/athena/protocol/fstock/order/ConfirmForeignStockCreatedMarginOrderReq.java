...
/**
 * @Description 外国株式取引サービス - 外国株式信用新規建注文確認.
 * 
 * @author mengzhe.li
 * @date: 02/17/2022
 */
public class ConfirmForeignStockCreatedMarginOrderReq implements BaseRequest {
    
    public ConfirmForeignStockCreatedMarginOrderReq() {
