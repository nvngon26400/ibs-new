...
@Mapper
public interface IfaBrokerCodeClosingMonthLoginMapper {
    ...
    public IfaBrokerCodeClosingMonthLoginSql001ResponseModel selectIfaBrokerCodeClosingMonthLoginSql001(
        @Param("req") IfaBrokerCodeClosingMonthLoginSql001RequestModel req) throws Exception;
    ...
    public IfaBrokerCodeClosingMonthLoginSql002ResponseModel selectIfaBrokerCodeClosingMonthLoginSql002(
        @Param("req") IfaBrokerCodeClosingMonthLoginSql002RequestModel req) throws Exception;
    ...
    public IfaBrokerCodeClosingMonthLoginSql003ResponseModel selectIfaBrokerCodeClosingMonthLoginSql003(
        @Param("req") IfaBrokerCodeClosingMonthLoginSql003RequestModel req) throws Exception;
    ...
    public int updateIfaBrokerCodeClosingMonthLoginSql004(
        @Param("req") IfaBrokerCodeClosingMonthLoginSql004RequestModel req) throws Exception;
