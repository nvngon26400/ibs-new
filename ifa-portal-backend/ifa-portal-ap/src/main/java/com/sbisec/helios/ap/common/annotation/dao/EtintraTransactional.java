...
import com.sbisec.helios.ap.common.config.MybatisConfig.Etintra;

/**
 * etintraトランザクション指定アノテーション。
 * 
 * @author SCSK宮坂
 */
...
@Inherited
@Documented
@Transactional(Etintra.TRANSACTION_MANAGER_BEAN_NAME)
public @interface EtintraTransactional {
	/**
