...
import com.sbisec.helios.ap.api.pom.interceptor.RetryInterceptor;
 ...
 * @date 5/20/2021
 */
public class PomOkHttpClientManager implements Cloneable {
    
    private static class OkHttpClientInternal {
        
        private static final PomOkHttpClientManager INSTANCE = new PomOkHttpClientManager();
    }
    ...
    private PomOkHttpClientManager() {
    ...
    public PomOkHttpClientManager setReadTimeout(long readTimeout) {
        
        this.readTimeout = readTimeout;
        return this;
    }
    
    public PomOkHttpClientManager setWriteTimeout(long writeTimeout) {
        
        this.writeTimeout = writeTimeout;
        return this;
    }
    
    public PomOkHttpClientManager setConnTimeout(long connTimeout) {
        
        this.connTimeout = connTimeout;
        return this;
    }
    
    public PomOkHttpClientManager setConnPoolTimeout(int connPoolTimeout) {
        
        this.connPoolTimeout = connPoolTimeout;
        return this;
    }
    
    public PomOkHttpClientManager setConnPoolCachedMax(int connPoolCachedMax) {
        
        this.connPoolCachedMax = connPoolCachedMax;
        return this;
    }
    
    public PomOkHttpClientManager setRetryCount(int retryCount) {
        
        this.retryCount = retryCount;
        return this;
    }
    
    public OkHttpClient getClient() throws PomException {
    ...
    protected static final PomOkHttpClientManager getInstance() {
