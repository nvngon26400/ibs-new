 ...
 */
@Mapper
public interface IfaDocClassListMapper {
     ...
     */
    public List<IfaDocClassListSql001ResponseModel> selectIfaDocClassListSql001(
            @Param("req") IfaDocClassListSql001RequestModel req) throws Exception;
     ...
     * レスポンスクラス：IfaDocClassListSql002ResponseModel
     *
     * @param req リクエストパラメタ
     * @return 登録レコード数
    ...
    public int insertIfaDocClassListSql002(
            @Param("req") IfaDocClassListSql002RequestModel req) throws Exception;
    ...
    public int updateIfaDocClassListSql003(
            @Param("req") IfaDocClassListSql003RequestModel req) throws Exception;
    ...
    public int updateIfaDocClassListSql004(
            @Param("req") IfaDocClassListSql004RequestModel req) throws Exception;
     ...
     */
    public List<IfaDocClassListSql005ResponseModel> selectIfaDocClassListSql005(
            @Param("req") IfaDocClassListSql005RequestModel req) throws Exception;
