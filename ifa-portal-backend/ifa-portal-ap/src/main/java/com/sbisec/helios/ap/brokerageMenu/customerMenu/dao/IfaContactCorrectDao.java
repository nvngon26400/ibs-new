 ...
 * @author 大連 王永宝
 */
public interface IfaContactCorrectDao {
    ...
    public int updateIfaContactCorrectSql004(
            IfaContactCorrectSql004RequestModel x_req) throws Exception;
    ...
    public int updateIfaContactCorrectSql006(
            IfaContactCorrectSql006RequestModel x_req) throws Exception;
    ...
    public int insertIfaContactCorrectSql008(
            IfaContactCorrectSql008RequestModel x_req) throws Exception;
    ...
    public int insertIfaContactCorrectSql009(
            IfaContactCorrectSql009RequestModel x_req) throws Exception;
    ...
    public int updateIfaContactCorrectSql010(
            IfaContactCorrectSql010RequestModel x_req) throws Exception;
    ...
    public int insertIfaContactCorrectSql011(
            IfaContactCorrectSql011RequestModel x_req) throws Exception;
}
