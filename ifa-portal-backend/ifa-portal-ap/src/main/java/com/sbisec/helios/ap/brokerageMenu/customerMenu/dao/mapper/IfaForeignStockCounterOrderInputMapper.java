 ...
 */
@Mapper
public interface IfaForeignStockCounterOrderInputMapper {
     ...
     */
    public List<IfaForeignStockCounterOrderInputSql001ResponseModel> selectIfaForeignStockCounterOrderInputSql001(
            @Param("req") IfaForeignStockCounterOrderInputSql001RequestModel req
    ) throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql002ResponseModel> selectIfaForeignStockCounterOrderInputSql002() throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql003ResponseModel> selectIfaForeignStockCounterOrderInputSql003(
            @Param("req") IfaForeignStockCounterOrderInputSql003RequestModel req
    ) throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql004ResponseModel> selectIfaForeignStockCounterOrderInputSql004(
            @Param("req") IfaForeignStockCounterOrderInputSql004RequestModel req
    ) throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql005ResponseModel> selectIfaForeignStockCounterOrderInputSql005() throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql006ResponseModel> selectIfaForeignStockCounterOrderInputSql006() throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql007ResponseModel> selectIfaForeignStockCounterOrderInputSql007() throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql008ResponseModel> selectIfaForeignStockCounterOrderInputSql008() throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql009ResponseModel> selectIfaForeignStockCounterOrderInputSql009() throws Exception;
     ...
     * @exception Exception システムエラー
     */
    public List<IfaForeignStockCounterOrderInputSql010ResponseModel> selectIfaForeignStockCounterOrderInputSql010() throws Exception;
