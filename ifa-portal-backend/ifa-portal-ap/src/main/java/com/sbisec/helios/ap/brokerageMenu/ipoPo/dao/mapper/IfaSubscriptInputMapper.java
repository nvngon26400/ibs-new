 ...
 */
@Mapper
public interface IfaSubscriptInputMapper {
     ...
     */
    public List<IfaSubscriptInputSql001ResponseModel> selectIfaSubscriptInputSql001(
            @Param("req") IfaSubscriptInputSql001RequestModel req) throws Exception;
     ...
     * @exception Exception SQLExceptionなど
     */
    public List<IfaSubscriptInputSql002ResponseModel> selectIfaSubscriptInputSql002(
            @Param("req") IfaSubscriptInputSql002RequestModel req) throws Exception;
     ...
     * @exception Exception SQLExceptionなど
     */
    public List<IfaSubscriptInputSql003ResponseModel> selectIfaSubscriptInputSql003(
            @Param("req") IfaSubscriptInputSql003RequestModel req) throws Exception;
     ...
     * @exception Exception SQLExceptionなど
     */
    public List<IfaSubscriptInputSql004ResponseModel> selectIfaSubscriptInputSql004(
            @Param("req") IfaSubscriptInputSql004RequestModel req) throws Exception;
     ...
     * @exception Exception SQLExceptionなど
     */
    public List<IfaSubscriptInputSql005ResponseModel> selectIfaSubscriptInputSql005() throws Exception;
     ...
     * @exception Exception SQLExceptionなど
     */
    public List<IfaSubscriptInputSql006ResponseModel> selectIfaSubscriptInputSql006(
            @Param("req") IfaSubscriptInputSql006RequestModel req) throws Exception;
     ...
     * @exception Exception SQLExceptionなど
     */
    public List<IfaSubscriptInputSql007ResponseModel> selectIfaSubscriptInputSql007(
            @Param("req") IfaSubscriptInputSql007RequestModel req) throws Exception;
     ...
     * @exception Exception SQLExceptionなど
     */
    public List<IfaSubscriptInputSql008ResponseModel> selectIfaSubscriptInputSql008(
            @Param("req") IfaSubscriptInputSql008RequestModel req) throws Exception;
