...
/**
 * IfaServiceNowBranchAndBrokerInfomation Mapper
 *
 * @author SCSK
 */
@Mapper
public interface IfaServiceNowBranchAndBrokerInfomationMapper {
    
    /**
     * 本店・支店情報取得
     */
    public List<IfaServiceNowBranchDto> selectA001Branch(
            @Param("req") IfaServiceNowBranchAndBrokerInfomationA001RequestDto req) throws Exception;
    
    /**
     * SBI証券本支店の仲介業者支店を取得
     */
    public List<IfaServiceNowBrokerDto> selectA002Broker(
            @Param("req") IfaServiceNowBranchAndBrokerInfomationA002RequestDto req) throws Exception;
    
    /**
     * 仲介業社支店一覧取得
     */
    public List<IfaServiceNowBrokerDto> selectA003Broker(
            @Param("req") IfaServiceNowBranchAndBrokerInfomationA003RequestDto req) throws Exception;
    
    /**
     * 営業員一覧を取得
     */
    public List<IfaServiceNowEmployeeDto> selectA004Employee(
            @Param("req") IfaServiceNowBranchAndBrokerInfomationA004RequestDto req) throws Exception;
