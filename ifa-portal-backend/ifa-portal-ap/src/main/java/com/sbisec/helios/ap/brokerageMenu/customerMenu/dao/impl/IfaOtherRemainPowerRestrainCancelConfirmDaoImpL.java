...
import com.sbisec.helios.ap.brokerageMenu.customerMenu.dao.mapper.IfaOtherRemainPowerRestrainCancelConfirmMapper;
 ...
 */
@Component
public class IfaOtherRemainPowerRestrainCancelConfirmDaoImpL extends RowSelectableDao 
    implements IfaOtherRemainPowerRestrainCancelConfirmDao {

    @Autowired
    private IfaOtherRemainPowerRestrainCancelConfirmMapper g_mapper;
    ...
    public DataList<IfaOtherRemainPowerRestrainCancelConfirmSql001ResponseModel> selectIfaOtherRemainPowerRestrainCancelConfirmSql001(
        ...
        // 結果の格納先を準備
        DataList<IfaOtherRemainPowerRestrainCancelConfirmSql001ResponseModel> p_res = new DataList<IfaOtherRemainPowerRestrainCancelConfirmSql001ResponseModel>();
        // SQLを実行し結果を格納    
        p_res.setDataList(g_mapper.selectIfaOtherRemainPowerRestrainCancelConfirmSql001(x_req));
    ...
    public int selectIfaOtherRemainPowerRestrainCancelConfirmSql002(
        ...
        return g_mapper.selectIfaOtherRemainPowerRestrainCancelConfirmSql002(x_req);
    }
    ...
    public int insertIfaOtherRemainPowerRestrainCancelConfirmSql003(
        ...
        return g_mapper.insertIfaOtherRemainPowerRestrainCancelConfirmSql003(x_req);
    }
    ...
    public int updateIfaOtherRemainPowerRestrainCancelConfirmSql004(
        ...
        return g_mapper.updateIfaOtherRemainPowerRestrainCancelConfirmSql004(x_req);
    }
}
