 ...
 */
@Mapper
public interface IfaDocRequestExecuteConfirmMapper {
     ...
     * @return int
     * @throws Exception書類請求確認処理で例外が発生した場合
     */
    public int insertIfaDocRequestExecuteConfirmSql001(@Param("req") IfaDocRequestExecuteConfirmSql001RequestModel req)
            throws Exception;
     ...
     */
    public List<IfaDocRequestExecuteConfirmSql002ResponseModel> selectIfaDocRequestExecuteConfirmSql002(
            @Param("req") IfaDocRequestExecuteConfirmSql002RequestModel req) throws Exception;
     ...
     */
    public List<IfaDocRequestExecuteConfirmSql003ResponseModel> selectIfaDocRequestExecuteConfirmSql003(
            @Param("req") IfaDocRequestExecuteConfirmSql003RequestModel req) throws Exception;
     ...
     */
    public List<IfaDocRequestExecuteConfirmSql004ResponseModel> selectIfaDocRequestExecuteConfirmSql004()
            throws Exception;
     ...
     */
    public int insertIfaDocRequestExecuteConfirmSql005(@Param("req") IfaDocRequestExecuteConfirmSql005RequestModel req)
            throws Exception;
