...
import com.sbisec.helios.ap.brokerageMenu.customerMenu.dao.mapper.IfaForeignMarginCollateralTransferConfirmMapper;
 ...
 */
@Component
public class IfaForeignMarginCollateralTransferConfirmDaoImpL extends RowSelectableDao
        implements IfaForeignMarginCollateralTransferConfirmDao {
    
    @Autowired
    private IfaForeignMarginCollateralTransferConfirmMapper mapper;
    ...
    public DataList<IfaForeignMarginCollateralTransferConfirmSql001ResponseModel> 
        ...
        DataList<IfaForeignMarginCollateralTransferConfirmSql001ResponseModel> res = 
                new DataList<IfaForeignMarginCollateralTransferConfirmSql001ResponseModel>();
        
        res.setDataList(mapper.selectIfaForeignMarginCollateralTransferConfirmSql001(req));
        return res;
    }
    ...
    public int insertIfaForeignMarginCollateralTransferConfirmSql002(
        ...
        return mapper.insertIfaForeignMarginCollateralTransferConfirmSql002(req);
    }
    ...
    public int updateIfaForeignMarginCollateralTransferConfirmSql003(
        ...
        return mapper.updateIfaForeignMarginCollateralTransferConfirmSql003(req);
    }
    ...
    public String selectIfaForeignMarginCollateralTransferConfirmSql004() throws Exception {
        ...
        return mapper.selectIfaForeignMarginCollateralTransferConfirmSql004();
    }
}
