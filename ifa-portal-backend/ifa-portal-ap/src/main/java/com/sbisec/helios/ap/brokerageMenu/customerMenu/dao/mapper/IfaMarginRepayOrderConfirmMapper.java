 ...
 */
@Mapper
public interface IfaMarginRepayOrderConfirmMapper {
    ...
    *
     ...
     */
    public int insertIfaMarginRepayOrderConfirmSql001(@Param("req") IfaMarginRepayOrderConfirmSql001RequestModel req)
            throws Exception;
     ...
     * @exception Exception 例外が発生した場合
     */
    public int insertIfaMarginRepayOrderConfirmSql002(@Param("req") IfaMarginRepayOrderConfirmSql002RequestModel req)
            throws Exception;
     ...
     * @exception Exception 例外が発生した場合
     */
    public int updateIfaMarginRepayOrderConfirmSql003(@Param("req") IfaMarginRepayOrderConfirmSql003RequestModel req)
            throws Exception;
     ...
     * @exception Exception 例外が発生した場合
     */
    public int updateIfaMarginRepayOrderConfirmSql003b(@Param("req") IfaMarginRepayOrderConfirmSql003RequestModel req)
            throws Exception;
