...
/**
 * 外国現物取引注文入力注文確認APIレスポンス
 *
 * @author SCSK 宇田川達弥
 */
@Data
public class IfaForeignSpotTradeOrderInputA013ApiResponse {
    ...
    /** 市場情報. */
    private IfaForeignSpotTradeOrderInputA013ApiResponseMarketInfo marketInfo;
    ...
    /** 銘柄情報. */
    private IfaForeignSpotTradeOrderInputA013ApiResponseBrandInfo brandInfo;
    ...
    /** 確認項目リスト. */
    private List<IfaForeignSpotTradeOrderInputA013ApiResponseConfirmItem> confirmItemList;
    
    /** コンプラチェック_判定結果（全角半角）. */
    private String complianceCheckResult;
    
    /** コンプラチェックリスト. */
    private List<IfaForeignSpotTradeOrderInputA013ApiResponseComplianceCheck> complianceCheckList;
