 ...
 */
@Data
public class IfaMutualFundDetailInfoA001ApiResponse {
    ...
    /** 当月休場日リスト. */
    private String thisMonthClosedDayList;
    ...
    /** 翌月休場日リスト. */
    private String nextMonthClosedDayList;
    ...
    /** 償還優遇の適用（全角半角）. */
    private String preferentialRedemptionApplication;
