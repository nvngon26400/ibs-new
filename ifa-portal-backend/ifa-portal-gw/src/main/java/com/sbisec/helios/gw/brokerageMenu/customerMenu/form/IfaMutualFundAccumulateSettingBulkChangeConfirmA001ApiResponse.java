...
/**
 * 投信積立設定一括変更確認 A001 リスポンス
 *
 * @author nicksen.li
 */
@Data
public class IfaMutualFundAccumulateSettingBulkChangeConfirmA001ApiResponse {
...
//    private String startCriteriaConfirmMsg;
    ...
    /** リクエスト内容. */
    private IfaMutualFundAccumulateSettingBulkChangeConfirmA001ApiRequest requestContents;
