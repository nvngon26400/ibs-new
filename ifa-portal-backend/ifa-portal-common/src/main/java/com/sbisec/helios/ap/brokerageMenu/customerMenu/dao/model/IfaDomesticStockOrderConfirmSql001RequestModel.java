...
@Data
public class IfaDomesticStockOrderConfirmSql001RequestModel {
	...
	/** 確認項目リスト.インサイダー確認. */
	private String insiderCheck;

	/** 確認項目リスト.SOR確認. */
	private String sorCheck;

	/** アラート内容確認リスト.コンプラチェックワーニング確認. */
	private String complaCheckWarning;
	...
	/** 自動注文種別. */
	private String automaticOrderClassification;
	...
	/** EC受注番号訂正時. */
	private String ecWhentheOrderNumbercorrected;

	/** RBE注文ステータス. */
	private String rebOrderStatus;
	...
	/** CCS送付日. */
	private String cssDateofdelivery;
