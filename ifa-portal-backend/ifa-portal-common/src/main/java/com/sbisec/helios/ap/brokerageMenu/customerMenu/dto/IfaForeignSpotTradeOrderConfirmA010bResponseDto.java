 ...
 */
@Data
public class IfaForeignSpotTradeOrderConfirmA010bResponseDto {
    
    /** 注文情報. */
    private List<IfaForeignSpotTradeOrderConfirmA010ResponseDtoOrder> orderList;
    ...
    /** 確認項目. */
    private List<IfaForeignSpotTradeOrderConfirmA010ResponseDtoCheck> checkList;
    
    /** アラート内容確認. */
    private List<IfaForeignSpotTradeOrderConfirmA010ResponseDtoAlertCheck> alertCheckList;
    ...
    /** コンプラランクチェック. */
    private List<IfaForeignSpotTradeOrderConfirmA010ResponseDtoComplianceCheck> complianceCheckList;
