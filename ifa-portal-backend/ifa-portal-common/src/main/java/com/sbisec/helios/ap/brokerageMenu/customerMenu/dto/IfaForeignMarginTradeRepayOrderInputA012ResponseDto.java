...
@Data
public class IfaForeignMarginTradeRepayOrderInputA012ResponseDto {
    ...
    /** 約定数量（合計） */
    private String tradeQuantityTotal;
    ...
    /** 逆指値注文即時発火メッセージ */
    private List<String> methodCheckMessage;
    ...
    /** 現地約定日超過メッセージ. */
    private List<String> localTradeDateLimitMsg;
