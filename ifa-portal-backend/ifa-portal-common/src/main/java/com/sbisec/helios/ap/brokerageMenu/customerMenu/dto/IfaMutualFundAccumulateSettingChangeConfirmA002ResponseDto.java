...
/**
 * 投信積立設定変更確認 A002 リクエスト
 *
 * @author nicksen.li
 */
@Data
public class IfaMutualFundAccumulateSettingChangeConfirmA002ResponseDto {
    ...
    /** リクエスト内容. */
    private IfaMutualFundAccumulateSettingChangeConfirmA002RequestDto requestContents;
