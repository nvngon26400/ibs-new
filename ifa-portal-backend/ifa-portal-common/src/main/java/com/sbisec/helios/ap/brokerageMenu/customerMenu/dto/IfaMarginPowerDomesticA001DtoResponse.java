 ...
 */
@Data
public class IfaMarginPowerDomesticA001DtoResponse {
    ...
    /** 追証情報リスト */
    private List<IfaMarginPowerDomesticA001DtoResponseMarginCallinfo> marginCallinfoList;
    
    /** 受渡日（T+0）～受渡日（T+5）リスト */
    private List<IfaMarginPowerDomesticA001DtoResponseDeliveryDateToFiveDaysLater> deliveryDateToFiveDaysLaterList;
