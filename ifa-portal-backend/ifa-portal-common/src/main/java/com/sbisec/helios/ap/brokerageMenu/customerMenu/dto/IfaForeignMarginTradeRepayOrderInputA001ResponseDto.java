...
@Data
public class IfaForeignMarginTradeRepayOrderInputA001ResponseDto {
    ...
    /** 価格基本情報. */
    private IfaForeignMarginTradeRepayOrderInputResponseDto_PriceBasicInfo priceBasicInfo;
    ...
    /** 外国株式信用建玉サマリ. */
    private IfaForeignMarginTradeRepayOrderInputResponseDto_ForeignStockMarginPositionSummary foreignStockMarginPositionSummary;
    
    /** 外国株式信用建玉明細一覧. */
    private List<IfaForeignMarginTradeRepayOrderInputResponseDto_ForeignStockMarginPositionDetailList> foreignStockMarginPositionDetailList;
