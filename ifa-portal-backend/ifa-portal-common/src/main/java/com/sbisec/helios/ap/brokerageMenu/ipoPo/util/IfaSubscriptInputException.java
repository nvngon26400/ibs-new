 ...
 *
 */
public class IfaSubscriptInputException extends RuntimeException {
    /*　Serial Version UID */
     ...
     */
    public IfaSubscriptInputException(String messageId) {
     ...
     */
    public IfaSubscriptInputException(String messageId, String[] messageParams) {
     ...
     * @param cause 発生元例外
     */
    public IfaSubscriptInputException(String messageId, Throwable cause) {
     ...
     * @param cause 発生元例外
     */
    public IfaSubscriptInputException(String messageId, String[] messageParams, Throwable cause) {
