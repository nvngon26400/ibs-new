...
@Data
public class IfaKnockInKnockOutBrandHoldingListSql001ResponseModel {
    ...
    /** ノックイン水準価格（数値(小数)）. （ノックイン用パラメータ）*/
    private String knockInLevelPrice;

    /** ノックイン発生日.（ノックイン用パラメータ） */
    private String knockinDate;

    /** 早期償還水準価格. （ノックアウト用パラメータ）*/
    private String earlyRedemptionLevelPrice;

    /** 早期償還決定日. （ノックアウト用パラメータ）*/
    private String earlyRedemptionDeterminationDate;
